...
This project demonstrates practical application of AI and ML concepts, including text preprocessing, feature extraction, and classification.
...
• 📄 **CSV file:** `fake_or_real_news.csv`  
...
> ⚠️ Note: The dataset is large, so it is uploaded externally. 
